...
<div class="sidebar d-flex flex-column vh-100 position-fixed shadow-lg" id="sidebar">
  ...
  <!-- Navigation -->
    <div class="mt-4 flex-grow-1">
      <a href="#" class="nav-link px-3 py-2 active">
        <i class="bi bi-speedometer2 me-3"></i> Dashboard
      </a>
      <a href="#" class="nav-link px-3 py-2">
        <i class="bi bi-file-earmark-text me-3"></i> Module
      </a>
      <a href="#" class="nav-link px-3 py-2 ">
        <i class="bi bi-file-earmark-text me-3"></i> Module
      </a>
    ...
    >
      <div class="d-flex align-items-center">
        ...
        <div>
          ...
          <span class="small text-light">Admin</span>
        </div>
      </div>
  ...
  <div class="main-content" style="margin-left:260px;">
    ...
    <div class="page-header text-center my-4">
      <h1>Title</h1>
      <div class="page-subtitle">"Sub-title (optional)"</div>
    </div>
